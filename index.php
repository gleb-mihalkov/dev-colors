...
<main class="home-page">
    ...
    <div class="home-page__about">
        <article class="about-preview">
            ...
            <a href="/about" class="about-preview__link">
                <span>Читать полностью</span>
            </a>
        </article>
    </div>
    <div class="home-page__courses">
        <? $APPLICATION->IncludeComponent(
            "bitrix:news.list", 
            "courses-slider", 
            array(
                "COMPONENT_TEMPLATE" => "courses-slider",
                "IBLOCK_TYPE" => "Content",
                "IBLOCK_ID" => "7",
                "NEWS_COUNT" => "20",
                "SORT_BY1" => "SORT",
    ...
    <div class="home-page__responses">
        <? $APPLICATION->IncludeComponent(
            "bitrix:news.list", 
            "responses-slider", 
            array(
                "COMPONENT_TEMPLATE" => "responses-slider",
                "IBLOCK_TYPE" => "Content",
                "IBLOCK_ID" => "5",
                "NEWS_COUNT" => "20",
                "SORT_BY1" => "SORT",
